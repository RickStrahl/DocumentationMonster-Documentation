We want to hear from you, and you can contact us for support, questions and discussions, about Documentation Monster. 

## Technical Support
For technical support, bugs, feature requests or general usage discussion, there are a couple of avenues available to you:

* [Bugs and Feature Requests](https://github.com/RickStrahl/DocumentationMonster/issues) <small>(GitHub Issues)</small>   
The Documentation Monster **Github repository** can be used to report bugs, feature requests and any focused usability questions. GitHub Issues provide our official bug tracking mechanism, so you can also see what issues are open and what we're working on.
...
If you need to find your registration key for Documentation Monster, it can be found in one of the following:
